...
The following are prerequisites and configuration notes for the F5 3 NIC GDM template:
  ...
  - You must use a BIG-IP instance that has at least 4 vCPU and 4 GB memory. For each additional vCPU, add at least 2 GB of memory. Note: Because of this requirement, the *n1-highcpu* instance types are not supported.  The following are the minimum and default Google Cloud Instance sizes:
...
- name: bigip-3nic-setup
  ...
  properties:
   ...
   subnet2: subnet3
   ### Subnet of network2
   licenseKey1: PMTVS-ZGMPX-CENOY-JELIN-JEGDAKE
   ### BIG-IP license key
